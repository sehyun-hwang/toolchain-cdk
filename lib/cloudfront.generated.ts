...
import * as cdk_errors from "aws-cdk-lib/core";
...
export namespace CfnDistribution {
   ...
   */
  export interface GrpcConfigProperty {
    /**
...
/**
 * Determine whether the given properties match those of a `VpcOriginConfigProperty`
 *
 * @param properties - the TypeScript properties of a `VpcOriginConfigProperty`
 *
 * @returns the result of the validation.
 */
// @ts-ignore TS6133
function CfnDistributionVpcOriginConfigPropertyValidator(properties: any): cdk.ValidationResult {
  if (!cdk.canInspect(properties)) return cdk.VALIDATION_SUCCESS;
  const errors = new cdk.ValidationResults();
  if (!(properties && typeof properties == 'object' && !Array.isArray(properties))) {
    errors.collect(new cdk.ValidationResult("Expected an object, but received: " + JSON.stringify(properties)));
  ...
  errors.collect(cdk.propertyValidator("originKeepaliveTimeout", cdk.validateNumber)(properties.originKeepaliveTimeout));
  errors.collect(cdk.propertyValidator("originReadTimeout", cdk.validateNumber)(properties.originReadTimeout));
  errors.collect(cdk.propertyValidator("vpcOriginId", cdk.requiredValidator)(properties.vpcOriginId));
  errors.collect(cdk.propertyValidator("vpcOriginId", cdk.validateString)(properties.vpcOriginId));
  return errors.wrap("supplied properties not correct for \"VpcOriginConfigProperty\"");
}

// @ts-ignore TS6133
function convertCfnDistributionVpcOriginConfigPropertyToCloudFormation(properties: any): any {
  if (!cdk.canInspect(properties)) return properties;
  CfnDistributionVpcOriginConfigPropertyValidator(properties).assertSuccess();
  return {
    "OriginKeepaliveTimeout": cdk.numberToCloudFormation(properties.originKeepaliveTimeout),
    "OriginReadTimeout": cdk.numberToCloudFormation(properties.originReadTimeout),
    "VpcOriginId": cdk.stringToCloudFormation(properties.vpcOriginId)
  };
}

// @ts-ignore TS6133
function CfnDistributionVpcOriginConfigPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<cdk.IResolvable | CfnDistribution.VpcOriginConfigProperty> {
  if (cdk.isResolvableObject(properties)) {
    return new cfn_parse.FromCloudFormationResult(properties);
  }
  properties = ((properties == null) ? {} : properties);
  ...
  const ret = new cfn_parse.FromCloudFormationPropertyObject<CfnDistribution.VpcOriginConfigProperty>();
  ret.addPropertyResult("originKeepaliveTimeout", "OriginKeepaliveTimeout", (properties.OriginKeepaliveTimeout != null ? cfn_parse.FromCloudFormation.getNumber(properties.OriginKeepaliveTimeout) : undefined));
  ret.addPropertyResult("originReadTimeout", "OriginReadTimeout", (properties.OriginReadTimeout != null ? cfn_parse.FromCloudFormation.getNumber(properties.OriginReadTimeout) : undefined));
  ret.addPropertyResult("vpcOriginId", "VpcOriginId", (properties.VpcOriginId != null ? cfn_parse.FromCloudFormation.getString(properties.VpcOriginId) : undefined));
  ret.addUnrecognizedPropertiesAsExtra(properties);
  return ret;
}
...
function CfnDistributionOriginPropertyValidator(properties: any): cdk.ValidationResult {
  ...
  errors.collect(cdk.propertyValidator("vpcOriginConfig", CfnDistributionVpcOriginConfigPropertyValidator)(properties.vpcOriginConfig));
...
function convertCfnDistributionOriginPropertyToCloudFormation(properties: any): any {
  ...
  return {
    ...
    "VpcOriginConfig": convertCfnDistributionVpcOriginConfigPropertyToCloudFormation(properties.vpcOriginConfig)
  };
}
...
function CfnDistributionOriginPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<cdk.IResolvable | CfnDistribution.OriginProperty> {
  ...
  ret.addPropertyResult("vpcOriginConfig", "VpcOriginConfig", (properties.VpcOriginConfig != null ? CfnDistributionVpcOriginConfigPropertyFromCloudFormation(properties.VpcOriginConfig) : undefined));
  ret.addUnrecognizedPropertiesAsExtra(properties);
  return ret;
}
...
/**
 * Determine whether the given properties match those of a `GrpcConfigProperty`
 *
 * @param properties - the TypeScript properties of a `GrpcConfigProperty`
 *
 * @returns the result of the validation.
 */
// @ts-ignore TS6133
function CfnDistributionGrpcConfigPropertyValidator(properties: any): cdk.ValidationResult {
  if (!cdk.canInspect(properties)) return cdk.VALIDATION_SUCCESS;
  const errors = new cdk.ValidationResults();
  if (!(properties && typeof properties == 'object' && !Array.isArray(properties))) {
    errors.collect(new cdk.ValidationResult("Expected an object, but received: " + JSON.stringify(properties)));
  ...
  errors.collect(cdk.propertyValidator("enabled", cdk.requiredValidator)(properties.enabled));
  errors.collect(cdk.propertyValidator("enabled", cdk.validateBoolean)(properties.enabled));
  return errors.wrap("supplied properties not correct for \"GrpcConfigProperty\"");
}

// @ts-ignore TS6133
function convertCfnDistributionGrpcConfigPropertyToCloudFormation(properties: any): any {
  if (!cdk.canInspect(properties)) return properties;
  CfnDistributionGrpcConfigPropertyValidator(properties).assertSuccess();
  return {
    "Enabled": cdk.booleanToCloudFormation(properties.enabled)
  };
}
...
// @ts-ignore TS6133
function CfnDistributionGrpcConfigPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnDistribution.GrpcConfigProperty | cdk.IResolvable> {
  if (cdk.isResolvableObject(properties)) {
    return new cfn_parse.FromCloudFormationResult(properties);
  }
  properties = ((properties == null) ? {} : properties);
  ...
  const ret = new cfn_parse.FromCloudFormationPropertyObject<CfnDistribution.GrpcConfigProperty>();
  ret.addPropertyResult("enabled", "Enabled", (properties.Enabled != null ? cfn_parse.FromCloudFormation.getBoolean(properties.Enabled) : undefined));
  ret.addUnrecognizedPropertiesAsExtra(properties);
  return ret;
}
...
function CfnDistributionDefaultCacheBehaviorPropertyValidator(properties: any): cdk.ValidationResult {
  ...
  errors.collect(cdk.propertyValidator("grpcConfig", CfnDistributionGrpcConfigPropertyValidator)(properties.grpcConfig));
...
function convertCfnDistributionDefaultCacheBehaviorPropertyToCloudFormation(properties: any): any {
  ...
  return {
    ...
    "GrpcConfig": convertCfnDistributionGrpcConfigPropertyToCloudFormation(properties.grpcConfig),
...
function CfnDistributionDefaultCacheBehaviorPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnDistribution.DefaultCacheBehaviorProperty | cdk.IResolvable> {
  ...
  ret.addPropertyResult("grpcConfig", "GrpcConfig", (properties.GrpcConfig != null ? CfnDistributionGrpcConfigPropertyFromCloudFormation(properties.GrpcConfig) : undefined));
...
function CfnDistributionOriginGroupPropertyValidator(properties: any): cdk.ValidationResult {
  ...
  errors.collect(cdk.propertyValidator("selectionCriteria", cdk.validateString)(properties.selectionCriteria));
...
function convertCfnDistributionOriginGroupPropertyToCloudFormation(properties: any): any {
  ...
  return {
    ...
    "SelectionCriteria": cdk.stringToCloudFormation(properties.selectionCriteria)
  };
}
...
function CfnDistributionOriginGroupPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<cdk.IResolvable | CfnDistribution.OriginGroupProperty> {
  ...
  ret.addPropertyResult("selectionCriteria", "SelectionCriteria", (properties.SelectionCriteria != null ? cfn_parse.FromCloudFormation.getString(properties.SelectionCriteria) : undefined));
  ret.addUnrecognizedPropertiesAsExtra(properties);
  return ret;
}
...
function CfnDistributionDistributionConfigPropertyValidator(properties: any): cdk.ValidationResult {
  ...
  errors.collect(cdk.propertyValidator("anycastIpListId", cdk.validateString)(properties.anycastIpListId));
...
function convertCfnDistributionDistributionConfigPropertyToCloudFormation(properties: any): any {
  ...
  return {
    ...
    "AnycastIpListId": cdk.stringToCloudFormation(properties.anycastIpListId),
...
function CfnDistributionDistributionConfigPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnDistribution.DistributionConfigProperty | cdk.IResolvable> {
  ...
  ret.addPropertyResult("anycastIpListId", "AnycastIpListId", (properties.AnycastIpListId != null ? cfn_parse.FromCloudFormation.getString(properties.AnycastIpListId) : undefined));
 ...
 */
export class CfnAnycastIpList extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
  /**
   * The CloudFormation resource type name for this resource class.
   */
  public static readonly CFN_RESOURCE_TYPE_NAME: string = "AWS::CloudFront::AnycastIpList";
   ...
   * @internal
   */
  public static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAnycastIpList {
    resourceAttributes = resourceAttributes || {};
    const resourceProperties = options.parser.parseValue(resourceAttributes.Properties);
    const propsResult = CfnAnycastIpListPropsFromCloudFormation(resourceProperties);
    if (cdk.isResolvableObject(propsResult.value)) {
      throw new cdk_errors.ValidationError("Unexpected IResolvable", scope);
    }
    const ret = new CfnAnycastIpList(scope, id, propsResult.value);
    for (const [propKey, propVal] of Object.entries(propsResult.extraProperties)) {
      ret.addPropertyOverride(propKey, propVal);
    }
    options.parser.handleAttributes(ret, resourceAttributes, id);
   ...
   */
  public readonly attrAnycastIpList: cdk.IResolvable;
   ...
   * A complex type that contains zero or more `Tag` elements.
   */
  public tags?: CfnAnycastIpList.TagsProperty;
   ...
   * @param props Resource properties
   */
  public constructor(scope: constructs.Construct, id: string, props: CfnAnycastIpListProps) {
    super(scope, id, {
      "type": CfnAnycastIpList.CFN_RESOURCE_TYPE_NAME,
      "properties": props
    });

    cdk.requireProperty(props, "ipCount", this);
    cdk.requireProperty(props, "name", this);

    this.attrAnycastIpList = this.getAtt("AnycastIpList");
    this.attrETag = cdk.Token.asString(this.getAtt("ETag", cdk.ResolutionTypeHint.STRING));
    this.attrId = cdk.Token.asString(this.getAtt("Id", cdk.ResolutionTypeHint.STRING));
    this.cdkTagManager = new cdk.TagManager(cdk.TagType.STANDARD, "AWS::CloudFront::AnycastIpList", undefined, {
      "tagPropertyName": "tags"
    });
   ...
   */
  public inspect(inspector: cdk.TreeInspector): void {
    inspector.addAttribute("aws:cdk:cloudformation:type", CfnAnycastIpList.CFN_RESOURCE_TYPE_NAME);
    inspector.addAttribute("aws:cdk:cloudformation:props", this.cfnProperties);
  }

  protected renderProperties(props: Record<string, any>): Record<string, any> {
    return convertCfnAnycastIpListPropsToCloudFormation(props);
  }
}

export namespace CfnAnycastIpList {
  /**
   * A complex type that contains zero or more `Tag` elements.
   *
   * @struct
   ...
   */
  export interface AnycastIpListProperty {
    /**
 ...
 */
// @ts-ignore TS6133
function CfnAnycastIpListTagsPropertyValidator(properties: any): cdk.ValidationResult {
  if (!cdk.canInspect(properties)) return cdk.VALIDATION_SUCCESS;
  const errors = new cdk.ValidationResults();
  if (!(properties && typeof properties == 'object' && !Array.isArray(properties))) {
    errors.collect(new cdk.ValidationResult("Expected an object, but received: " + JSON.stringify(properties)));
  }
  errors.collect(cdk.propertyValidator("items", cdk.listValidator(cdk.validateCfnTag))(properties.items));
  return errors.wrap("supplied properties not correct for \"TagsProperty\"");
}

// @ts-ignore TS6133
function convertCfnAnycastIpListTagsPropertyToCloudFormation(properties: any): any {
  if (!cdk.canInspect(properties)) return properties;
  CfnAnycastIpListTagsPropertyValidator(properties).assertSuccess();
  return {
    "Items": cdk.listMapper(cdk.cfnTagToCloudFormation)(properties.items)
  };
}

// @ts-ignore TS6133
function CfnAnycastIpListTagsPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<cdk.IResolvable | CfnAnycastIpList.TagsProperty> {
  if (cdk.isResolvableObject(properties)) {
    return new cfn_parse.FromCloudFormationResult(properties);
  }
  properties = ((properties == null) ? {} : properties);
  ...
  const ret = new cfn_parse.FromCloudFormationPropertyObject<CfnAnycastIpList.TagsProperty>();
  ret.addPropertyResult("items", "Items", (properties.Items != null ? cfn_parse.FromCloudFormation.getArray(cfn_parse.FromCloudFormation.getCfnTag)(properties.Items) : undefined));
  ret.addUnrecognizedPropertiesAsExtra(properties);
  return ret;
}

/**
 * Determine whether the given properties match those of a `AnycastIpListProperty`
 *
 * @param properties - the TypeScript properties of a `AnycastIpListProperty`
 *
 * @returns the result of the validation.
 */
// @ts-ignore TS6133
function CfnAnycastIpListAnycastIpListPropertyValidator(properties: any): cdk.ValidationResult {
  if (!cdk.canInspect(properties)) return cdk.VALIDATION_SUCCESS;
  const errors = new cdk.ValidationResults();
  if (!(properties && typeof properties == 'object' && !Array.isArray(properties))) {
    errors.collect(new cdk.ValidationResult("Expected an object, but received: " + JSON.stringify(properties)));
  }
  errors.collect(cdk.propertyValidator("anycastIps", cdk.requiredValidator)(properties.anycastIps));
  errors.collect(cdk.propertyValidator("anycastIps", cdk.listValidator(cdk.validateString))(properties.anycastIps));
  errors.collect(cdk.propertyValidator("arn", cdk.requiredValidator)(properties.arn));
  errors.collect(cdk.propertyValidator("arn", cdk.validateString)(properties.arn));
  errors.collect(cdk.propertyValidator("id", cdk.requiredValidator)(properties.id));
  errors.collect(cdk.propertyValidator("id", cdk.validateString)(properties.id));
  errors.collect(cdk.propertyValidator("ipCount", cdk.requiredValidator)(properties.ipCount));
  errors.collect(cdk.propertyValidator("ipCount", cdk.validateNumber)(properties.ipCount));
  ...
  return errors.wrap("supplied properties not correct for \"AnycastIpListProperty\"");
}

// @ts-ignore TS6133
function convertCfnAnycastIpListAnycastIpListPropertyToCloudFormation(properties: any): any {
  if (!cdk.canInspect(properties)) return properties;
  CfnAnycastIpListAnycastIpListPropertyValidator(properties).assertSuccess();
  return {
    "AnycastIps": cdk.listMapper(cdk.stringToCloudFormation)(properties.anycastIps),
    "Arn": cdk.stringToCloudFormation(properties.arn),
    "Id": cdk.stringToCloudFormation(properties.id),
    "IpCount": cdk.numberToCloudFormation(properties.ipCount),
...
// @ts-ignore TS6133
function CfnAnycastIpListAnycastIpListPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnAnycastIpList.AnycastIpListProperty | cdk.IResolvable> {
  if (cdk.isResolvableObject(properties)) {
    return new cfn_parse.FromCloudFormationResult(properties);
  }
  properties = ((properties == null) ? {} : properties);
  ...
  const ret = new cfn_parse.FromCloudFormationPropertyObject<CfnAnycastIpList.AnycastIpListProperty>();
  ret.addPropertyResult("anycastIps", "AnycastIps", (properties.AnycastIps != null ? cfn_parse.FromCloudFormation.getArray(cfn_parse.FromCloudFormation.getString)(properties.AnycastIps) : undefined));
  ret.addPropertyResult("arn", "Arn", (properties.Arn != null ? cfn_parse.FromCloudFormation.getString(properties.Arn) : undefined));
  ret.addPropertyResult("id", "Id", (properties.Id != null ? cfn_parse.FromCloudFormation.getString(properties.Id) : undefined));
  ret.addPropertyResult("ipCount", "IpCount", (properties.IpCount != null ? cfn_parse.FromCloudFormation.getNumber(properties.IpCount) : undefined));
...
/**
 * Determine whether the given properties match those of a `CfnAnycastIpListProps`
 *
 * @param properties - the TypeScript properties of a `CfnAnycastIpListProps`
 *
 * @returns the result of the validation.
 */
// @ts-ignore TS6133
function CfnAnycastIpListPropsValidator(properties: any): cdk.ValidationResult {
  if (!cdk.canInspect(properties)) return cdk.VALIDATION_SUCCESS;
  const errors = new cdk.ValidationResults();
  if (!(properties && typeof properties == 'object' && !Array.isArray(properties))) {
    errors.collect(new cdk.ValidationResult("Expected an object, but received: " + JSON.stringify(properties)));
  ...
  errors.collect(cdk.propertyValidator("name", cdk.requiredValidator)(properties.name));
  errors.collect(cdk.propertyValidator("name", cdk.validateString)(properties.name));
  errors.collect(cdk.propertyValidator("tags", CfnAnycastIpListTagsPropertyValidator)(properties.tags));
  return errors.wrap("supplied properties not correct for \"CfnAnycastIpListProps\"");
}

// @ts-ignore TS6133
function convertCfnAnycastIpListPropsToCloudFormation(properties: any): any {
  if (!cdk.canInspect(properties)) return properties;
  CfnAnycastIpListPropsValidator(properties).assertSuccess();
  return {
    "IpCount": cdk.numberToCloudFormation(properties.ipCount),
    "Name": cdk.stringToCloudFormation(properties.name),
    "Tags": convertCfnAnycastIpListTagsPropertyToCloudFormation(properties.tags)
  };
}

// @ts-ignore TS6133
function CfnAnycastIpListPropsFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnAnycastIpListProps | cdk.IResolvable> {
  if (cdk.isResolvableObject(properties)) {
    return new cfn_parse.FromCloudFormationResult(properties);
  }
  properties = ((properties == null) ? {} : properties);
  ...
  const ret = new cfn_parse.FromCloudFormationPropertyObject<CfnAnycastIpListProps>();
  ret.addPropertyResult("ipCount", "IpCount", (properties.IpCount != null ? cfn_parse.FromCloudFormation.getNumber(properties.IpCount) : undefined));
  ret.addPropertyResult("name", "Name", (properties.Name != null ? cfn_parse.FromCloudFormation.getString(properties.Name) : undefined));
  ret.addPropertyResult("tags", "Tags", (properties.Tags != null ? CfnAnycastIpListTagsPropertyFromCloudFormation(properties.Tags) : undefined));
  ret.addUnrecognizedPropertiesAsExtra(properties);
  return ret;
}
 ...
 */
export class CfnVpcOrigin extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
  /**
   * The CloudFormation resource type name for this resource class.
   */
  public static readonly CFN_RESOURCE_TYPE_NAME: string = "AWS::CloudFront::VpcOrigin";
   ...
   * @internal
   */
  public static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnVpcOrigin {
    resourceAttributes = resourceAttributes || {};
    const resourceProperties = options.parser.parseValue(resourceAttributes.Properties);
    const propsResult = CfnVpcOriginPropsFromCloudFormation(resourceProperties);
    if (cdk.isResolvableObject(propsResult.value)) {
      throw new cdk_errors.ValidationError("Unexpected IResolvable", scope);
    }
    const ret = new CfnVpcOrigin(scope, id, propsResult.value);
    for (const [propKey, propVal] of Object.entries(propsResult.extraProperties)) {
      ret.addPropertyOverride(propKey, propVal);
    }
    options.parser.handleAttributes(ret, resourceAttributes, id);
   ...
   */
  public vpcOriginEndpointConfig: cdk.IResolvable | CfnVpcOrigin.VpcOriginEndpointConfigProperty;
   ...
   * @param props Resource properties
   */
  public constructor(scope: constructs.Construct, id: string, props: CfnVpcOriginProps) {
    super(scope, id, {
      "type": CfnVpcOrigin.CFN_RESOURCE_TYPE_NAME,
      "properties": props
    });

    cdk.requireProperty(props, "vpcOriginEndpointConfig", this);
    ...
    this.attrLastModifiedTime = cdk.Token.asString(this.getAtt("LastModifiedTime", cdk.ResolutionTypeHint.STRING));
    this.attrStatus = cdk.Token.asString(this.getAtt("Status", cdk.ResolutionTypeHint.STRING));
    this.cdkTagManager = new cdk.TagManager(cdk.TagType.STANDARD, "AWS::CloudFront::VpcOrigin", undefined, {
      "tagPropertyName": "tags"
    });
    this.tags = props.tags;
    this.vpcOriginEndpointConfig = props.vpcOriginEndpointConfig;
  }

  protected get cfnProperties(): Record<string, any> {
    return {
      "tags": this.cdkTagManager.renderTags(this.tags),
      "vpcOriginEndpointConfig": this.vpcOriginEndpointConfig
    };
  }
   ...
   */
  public inspect(inspector: cdk.TreeInspector): void {
    inspector.addAttribute("aws:cdk:cloudformation:type", CfnVpcOrigin.CFN_RESOURCE_TYPE_NAME);
    inspector.addAttribute("aws:cdk:cloudformation:props", this.cfnProperties);
  }

  protected renderProperties(props: Record<string, any>): Record<string, any> {
    return convertCfnVpcOriginPropsToCloudFormation(props);
  }
}

export namespace CfnVpcOrigin {
  /**
...
/**
 * Determine whether the given properties match those of a `VpcOriginEndpointConfigProperty`
 *
 * @param properties - the TypeScript properties of a `VpcOriginEndpointConfigProperty`
 *
 * @returns the result of the validation.
 */
// @ts-ignore TS6133
function CfnVpcOriginVpcOriginEndpointConfigPropertyValidator(properties: any): cdk.ValidationResult {
  if (!cdk.canInspect(properties)) return cdk.VALIDATION_SUCCESS;
  const errors = new cdk.ValidationResults();
  if (!(properties && typeof properties == 'object' && !Array.isArray(properties))) {
    errors.collect(new cdk.ValidationResult("Expected an object, but received: " + JSON.stringify(properties)));
  ...
  errors.collect(cdk.propertyValidator("originProtocolPolicy", cdk.validateString)(properties.originProtocolPolicy));
  errors.collect(cdk.propertyValidator("originSslProtocols", cdk.listValidator(cdk.validateString))(properties.originSslProtocols));
  return errors.wrap("supplied properties not correct for \"VpcOriginEndpointConfigProperty\"");
}

// @ts-ignore TS6133
function convertCfnVpcOriginVpcOriginEndpointConfigPropertyToCloudFormation(properties: any): any {
  if (!cdk.canInspect(properties)) return properties;
  CfnVpcOriginVpcOriginEndpointConfigPropertyValidator(properties).assertSuccess();
  return {
    "Arn": cdk.stringToCloudFormation(properties.arn),
    "HTTPPort": cdk.numberToCloudFormation(properties.httpPort),
    "HTTPSPort": cdk.numberToCloudFormation(properties.httpsPort),
...
// @ts-ignore TS6133
function CfnVpcOriginVpcOriginEndpointConfigPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<cdk.IResolvable | CfnVpcOrigin.VpcOriginEndpointConfigProperty> {
  if (cdk.isResolvableObject(properties)) {
    return new cfn_parse.FromCloudFormationResult(properties);
  }
  properties = ((properties == null) ? {} : properties);
  ...
  const ret = new cfn_parse.FromCloudFormationPropertyObject<CfnVpcOrigin.VpcOriginEndpointConfigProperty>();
  ret.addPropertyResult("arn", "Arn", (properties.Arn != null ? cfn_parse.FromCloudFormation.getString(properties.Arn) : undefined));
  ret.addPropertyResult("httpPort", "HTTPPort", (properties.HTTPPort != null ? cfn_parse.FromCloudFormation.getNumber(properties.HTTPPort) : undefined));
  ret.addPropertyResult("httpsPort", "HTTPSPort", (properties.HTTPSPort != null ? cfn_parse.FromCloudFormation.getNumber(properties.HTTPSPort) : undefined));
  ret.addPropertyResult("name", "Name", (properties.Name != null ? cfn_parse.FromCloudFormation.getString(properties.Name) : undefined));
...
/**
 * Determine whether the given properties match those of a `CfnVpcOriginProps`
 *
 * @param properties - the TypeScript properties of a `CfnVpcOriginProps`
 *
 * @returns the result of the validation.
 */
// @ts-ignore TS6133
function CfnVpcOriginPropsValidator(properties: any): cdk.ValidationResult {
  if (!cdk.canInspect(properties)) return cdk.VALIDATION_SUCCESS;
  const errors = new cdk.ValidationResults();
  if (!(properties && typeof properties == 'object' && !Array.isArray(properties))) {
    errors.collect(new cdk.ValidationResult("Expected an object, but received: " + JSON.stringify(properties)));
  ...
  errors.collect(cdk.propertyValidator("tags", cdk.listValidator(cdk.validateCfnTag))(properties.tags));
  errors.collect(cdk.propertyValidator("vpcOriginEndpointConfig", cdk.requiredValidator)(properties.vpcOriginEndpointConfig));
  errors.collect(cdk.propertyValidator("vpcOriginEndpointConfig", CfnVpcOriginVpcOriginEndpointConfigPropertyValidator)(properties.vpcOriginEndpointConfig));
  return errors.wrap("supplied properties not correct for \"CfnVpcOriginProps\"");
}

// @ts-ignore TS6133
function convertCfnVpcOriginPropsToCloudFormation(properties: any): any {
  if (!cdk.canInspect(properties)) return properties;
  CfnVpcOriginPropsValidator(properties).assertSuccess();
  return {
    "Tags": cdk.listMapper(cdk.cfnTagToCloudFormation)(properties.tags),
    "VpcOriginEndpointConfig": convertCfnVpcOriginVpcOriginEndpointConfigPropertyToCloudFormation(properties.vpcOriginEndpointConfig)
  };
}

// @ts-ignore TS6133
function CfnVpcOriginPropsFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnVpcOriginProps | cdk.IResolvable> {
  if (cdk.isResolvableObject(properties)) {
    return new cfn_parse.FromCloudFormationResult(properties);
  }
  properties = ((properties == null) ? {} : properties);
  ...
  const ret = new cfn_parse.FromCloudFormationPropertyObject<CfnVpcOriginProps>();
  ret.addPropertyResult("tags", "Tags", (properties.Tags != null ? cfn_parse.FromCloudFormation.getArray(cfn_parse.FromCloudFormation.getCfnTag)(properties.Tags) : undefined));
  ret.addPropertyResult("vpcOriginEndpointConfig", "VpcOriginEndpointConfig", (properties.VpcOriginEndpointConfig != null ? CfnVpcOriginVpcOriginEndpointConfigPropertyFromCloudFormation(properties.VpcOriginEndpointConfig) : undefined));
  ret.addUnrecognizedPropertiesAsExtra(properties);
  return ret;
}
